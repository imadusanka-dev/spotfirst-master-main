...
import { RejectedSubmissionItem } from './RejectedSubmissionItem'

export const RejectedSubmissions = () => {
  ...
  return (
    ...
    >
      ...
      <ul role="list" className="divide-y divide-gray-200">
        ...
        {!loading && rejectedSubmissions.length == 0 && (
        ...
        {!loading &&
          rejectedSubmissions.map((submission, index) => (
            <RejectedSubmissionItem key={index} submission={submission} />
          ))}
      </ul>
    </motion.section>
  )
