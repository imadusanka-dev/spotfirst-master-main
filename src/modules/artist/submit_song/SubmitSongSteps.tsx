...
import { setStep } from 'redux/slices/submitSong'

const SubmitSongSteps = () => {
  const { step, steps } = useAppSelector((state) => state.submitSongSlice)
...
export default SubmitSongSteps
